...
struct Traffic_Sign_List_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::t4ac_msgs::Traffic_Sign_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::t4ac_msgs::Traffic_Sign_<ContainerAllocator> >> _traffic_sign_list_type;
