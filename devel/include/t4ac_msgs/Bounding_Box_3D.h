...
struct Bounding_Box_3D_
{
  ...
  _h_type h;
   ...
   typedef std::vector< ::t4ac_msgs::Node_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::t4ac_msgs::Node_<ContainerAllocator> >> _corners_3d_type;
