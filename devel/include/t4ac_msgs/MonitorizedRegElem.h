...
struct MonitorizedRegElem_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::t4ac_msgs::RegulatoryElement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::t4ac_msgs::RegulatoryElement_<ContainerAllocator> >> _reg_elems_type;
