...
struct Bounding_Box_3D_list_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::t4ac_msgs::Bounding_Box_3D_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::t4ac_msgs::Bounding_Box_3D_<ContainerAllocator> >> _bounding_box_3d_list_type;
