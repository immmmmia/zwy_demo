...
struct RegulatoryElement_
{
  ...
  _distance_type distance;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _affecting_roads_type;
  _affecting_roads_type affecting_roads;

   typedef std::vector< ::t4ac_msgs::Landmark_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::t4ac_msgs::Landmark_<ContainerAllocator> >> _landmarks_type;
...
struct Printer< ::t4ac_msgs::RegulatoryElement_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::t4ac_msgs::RegulatoryElement_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.affecting_roads.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.affecting_roads[i]);
    }
