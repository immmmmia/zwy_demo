...
struct BEV_trackers_list_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::t4ac_msgs::BEV_tracker_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::t4ac_msgs::BEV_tracker_<ContainerAllocator> >> _bev_trackers_list_type;
