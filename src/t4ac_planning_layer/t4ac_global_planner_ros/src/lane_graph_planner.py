...
class LaneGraphPlanner():
    ...
    def calculate_lane_graph_connections(self, LANECHANGECOST):
        ...
        for road in self.map_object.roads:
            ...
            for lane in lanes:
                ...
                if (lane.id < 0 and lane.type == 'driving'):    # id<0: forward
                ...
                elif (lane.id > 0 and lane.type == 'driving'):  # id>0: backward
    ...
    def calculate_global_route(self, init_xyz, goal_xyz, weight="length"):
        ...
        init_roadlane = self.map_object.xyz_to_roadlane(init_xyz[0], init_xyz[1], init_xyz[2])  # 找到xyz最近的lane/road
